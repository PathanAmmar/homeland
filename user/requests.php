...
/* GET USER REQUESTED PROPERTIES + REQUEST STATUS */
...
style="background-image: url(<?php echo APPURL; ?>/images/hero_bg_2.jpg);" 
...
<span class="offer-type bg-<?php if($prop->type == "rent") { echo "success"; } else { echo "danger"; }?>">
<?php echo $prop->type; ?>
</span>
</div>

<img src="<?php echo APPURL; ?>/images/<?php echo $prop->image; ?>" class="img-fluid">
...
<a href="../payment/payment.php?property_id=<?php echo $prop->id; ?>" 
...
<div class="alert alert-warning mt-3">Waiting for admin approval</div>

<?php elseif($prop->status == "rejected") : ?>

<div class="alert alert-danger mt-3">Request Rejected</div>
...
<div class="alert alert-success bg-success text-white mt-5">
you did not do a request for any property just yet
</div>
