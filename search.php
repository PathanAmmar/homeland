...
if(isset($_POST['submit'])) {
  ...
  $search = $conn->prepare("SELECT * FROM props 
...
<span class="d-inline-block bg-<?php if($prop->type == "rent") { echo "success"; } else { echo "danger"; }?> text-white px-3 mb-3 property-offer-type rounded">
<?php echo $prop->type; ?>
</span>
...
<p>
<a href="property-details.php?id=<?php echo $prop->id; ?>" class="btn btn-white btn-outline-white py-3 px-5 rounded-0 btn-2">
See Details
</a>
</p>
...
<select name="types" class="form-control rounded-0">
...
<div class="select-wrap">
<select name="offers" class="form-control rounded-0">
...
<div class="select-wrap">
<select name="cities" class="form-control rounded-0">
...
<div class="col-md-3">
<input type="submit" name="submit" value="Search" class="btn btn-success text-white btn-block rounded-0">
</div>
...
<span class="offer-type bg-<?php if($listing->type == "rent") { echo "success"; } else { echo "danger"; }?>">
<?php echo $listing->type; ?>
</span>
</div>

<img src="images/<?php echo $listing->image; ?>" class="img-fluid">
...
<a href="property-details.php?id=<?php echo $listing->id; ?>">
...
<strong class="property-price text-success d-block mb-3">
$<?php echo $listing->price; ?>
</strong>

<ul class="property-specs-wrap mb-3">
...
We don't have any Property that matches your search criteria. Please try again.
</div>
