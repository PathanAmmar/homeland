        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              ...
              <p>Homeland is a modern real estate platform designed to connect buyers, sellers, and renters with the best property opportunities. Our mission is to simplify the property search process by offering reliable listings, expert support, and a user-friendly experience.</p>
            </div>
          </div>
